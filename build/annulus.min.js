...
class Annulus {
  ...
  createPath() {
    ...
    const t = r * (1.0 - thickness); // Clear out the debug stuff
    ...
    for (let i = 0; i <= in_segs; i++) {
      ...
      if (i == 0) p += " M" + px.toFixed(5) + "," + py.toFixed(5);else p += " C" + cx1.toFixed(5) + "," + cy1.toFixed(5) + " " + cx2.toFixed(5) + "," + cy2.toFixed(5) + " " + px.toFixed(5) + "," + py.toFixed(5);
      if (this._showDebug == false) continue; // Only boring debug-stuffs below
      ...
      l1.setAttributeNS(null, 'd', "M" + cx2.toFixed(5) + "," + cy2.toFixed(5) + " L" + px.toFixed(5) + "," + py.toFixed(5) + " M" + cx1.toFixed(5) + "," + cy1.toFixed(5) + " L" + (Math.cos(theta - theta_step) * re).toFixed(5) + "," + (Math.sin(theta - theta_step) * re).toFixed(5) + " Z");
    ...
    for (let i = 0; i <= out_segs; i++) {
      ...
      if (i == 0) p += " M" + px + "," + py;else p += " L" + px + "," + py;
    }
