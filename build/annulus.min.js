...
class RingVis extends Vis {
  ...
  update(elem) {
    ...
    const color_str = rgbToHex(super.stressToColor(this._parent.stress)); // Clear out the old stuff
    ...
    for (let i = 0; i <= out_segs; i++) {
      ...
      theta += theta_step * (1 - osc + .48); //theta =next_theta();
...
class WeerVis extends Vis {
  ...
  update(elem) {
    ...
    let y = .25 * r;
    let y2 = .5 - this._parent._stress / EXCITEMENT_SCALE; // Mouth
