...
class Annulus {
  constructor(svgarea) {
    ...
    svgarea.viewbox = [-2, -2, 4, 4]; // create the circle node, set attributes, and append it to the SVG node
  ...
  createPath() {
    ...
    for (let i = 0; i <= in_segs; i++) {
      ...
      if (i == 0) p += " M" + px.toFixed(5) + "," + py.toFixed(5);else p += " C" + cx1.toFixed(5) + "," + cy1.toFixed(5) + " " + cx2.toFixed(5) + "," + cy2.toFixed(5) + " " + px.toFixed(5) + "," + py.toFixed(5); //if( i != 0 ) continue;
